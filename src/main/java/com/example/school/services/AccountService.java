...
public class AccountService {
    ...
    public void signup(SignUp request) {
        ...
        Optional<Account> existingUser = repo.findByUsername(username);
        ...
        Account account= new Account(request.getUsername(),request.getEmail(),hashedPassword,UserType.STUDENT);
